            ...
            <div class="col-lg-12">
                <div class="shop-breadcrumb">
                    <div class="breadcrumb-main">
                        <h4 class="text-capitalize breadcrumb-title">Update class</h4>
                                    ...
                                    <div class="card-body p-0">
                                        ...
                                        <div class="add-product__body px-sm-40 px-20">
                                            ...
                                            <form action="{{ route('admin.classes.update', $class->id) }}" method="POST">
                                                ...
                                                <div class="form-group mb-20">
                                                    <label for="name1">Date Start (Not required)</label>
                                                    <input type="date" class="form-control" id="name1"
                                                        placeholder="{{ $class->date_start }}" name="date_start"
                                                        value="{{ old('class_name') ?? $class->date_start }}">
                                                ...
                                                <div class=" mb-20">
                                                    <div class="time-picker">
                                                        <div class="form-group mb-0">
                                                            <label for="name1">Time Study (Not required)</label>
                                                            ...
                                                            <div
                                                                ...
                                                                <input type="text"
                                                                    ...
                                                                    placeholder="12:00 AM" name="time_study" value="{{$class->time_study}}">
